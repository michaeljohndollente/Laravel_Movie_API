            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <a class="nav-link linkIndex" href="#register" data-bs-toggle="modal" data-bs-target="#registerModal" data-id="register">Register</a>
                        <a class="nav-link linkIndex" href="#login" data-bs-toggle="modal" data-bs-target="#loginModal" data-id="login">Login</a>
                    </div>
                </div>
            </nav>
        </div>
