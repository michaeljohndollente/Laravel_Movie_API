  ...
  <div class="collapse navbar-collapse nav-piils" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link link" id="#v-piils-movie-tab" data-bs-toggle="piil" href="#movie" 
        role="tab" aria-controls="v-pills-movie" aria-selected="true" data-id="movie">Movies</a>
      </li>
      <li class="nav-item">
        <a class="nav-link link" id="#v-piils-actor-tab" data-bs-toggle="piil" href="#actor" 
        role="tab" aria-controls="v-pills-actor" aria-selected="true" data-id="actor">Actors</a>
      </li>
      <li class="nav-item">
        <a class="nav-link link" id="#v-piils-role-tab" data-bs-toggle="piil" href="#role" 
        role="tab" aria-controls="v-pills-role" aria-selected="true" data-id="role">Roles</a>
      </li>
      <li class="nav-item">
        <a class="nav-link link" id="#v-piils-rate-tab" data-bs-toggle="piil" href="#rate" 
        role="tab" aria-controls="v-pills-rate" aria-selected="true" data-id="rate">Rates</a>
      </li>
      <li class="nav-item">
        <a class="nav-link link" id="#v-piils-genre-tab" data-bs-toggle="piil" href="#genre" 
        role="tab" aria-controls="v-pills-genre" aria-selected="true" data-id="genre">Genres</a>
      </li>
      <li class="nav-item">
        <a class="nav-link link" id="#v-piils-producer-tab" data-bs-toggle="piil" href="#producer" 
